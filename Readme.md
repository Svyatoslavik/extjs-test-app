...
Live demo: https://svyatoslavik.github.io/extjs-test-app/
...
only holds code, resources, etc. pieces that are used classic profile. The following 
additional directories are used to isolate code and other files that are 
toolkit-specific:
